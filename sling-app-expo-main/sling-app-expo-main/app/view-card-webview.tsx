...
export default function ViewCardWebView() {
  ...
  const handleNavigationStateChange = (navState: any) => {
    ...
    if (currentUrl.includes("success") || currentUrl.includes("completed")) {
      Alert.alert("Success", "Card details loaded successfully!", [
    ...
    // Check for callback URL
      ...
      Alert.alert("Card View", "Card viewing process completed. Redirecting back...", [
        { text: "OK", onPress: () => router.back() }
      ]);
    }
  };
    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>View Card</Text>
